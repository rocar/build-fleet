...
Unlike `spec.md` (authored once, up front, by the product-owner), `diagnosis.md` is filled
...
|---|---|---|
| `REPORTED` | the bug is filed (`/build-fleet:triage`) | REPORT |
