...
# staleness threshold (3600s); fresh markers and anything outside the
...
# make_stale <file>: push mtime well past the 3600s threshold (bash-3.2/BSD-safe)
...
# --- stale marker (past the 3600s threshold) is reaped, with a stderr notice ---
