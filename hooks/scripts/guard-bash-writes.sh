...
block() {
  echo "build-fleet: Bash write to '${1}' blocked — the active ${lane} '${slug}' is source-locked. Use the Write/Edit tools instead so the SDD gates can adjudicate (.sdd/ and tests/ remain writable)." >&2
